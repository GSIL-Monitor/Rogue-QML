...
void Box2DRevoluteJoint::setLocalAnchorA(const QPointF &localAnchorA)
{
    ...
    //TEST
    mRevoluteJointDef.localAnchorA.Set(localAnchorA.x()/ scaleRatio,(-localAnchorA.y()/ scaleRatio));
...
void Box2DRevoluteJoint::setLocalAnchorB(const QPointF &localAnchorB)
{
    ...
    //TEST
    mRevoluteJointDef.localAnchorB.Set(localAnchorB.x()/ scaleRatio, (-localAnchorB.y()/ scaleRatio));
